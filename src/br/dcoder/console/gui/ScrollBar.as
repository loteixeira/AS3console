...
package br.dcoder.console.gui
{
	...
	public class ScrollBar extends GUIBaseElement
	{
		...
		public function onStageMouseMove(event:MouseEvent):void
		{
			if (draggingThumb)
			{
				var pos:Point = content.globalToLocal(new Point(event.stageX, event.stageY));
