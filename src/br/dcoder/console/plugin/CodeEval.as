...
package br.dcoder.console.plugin
{
	...
	/**
	 * Plugin to run Actionscript3 code from a AS3console instance. Uses AS3 Eval Library to compile the source code to bytecode.
	 */
	public class CodeEval extends ConsolePlugin
	{
		...
		/**
		 * Create an instance of <code>CodeEval</code> plugin. Using this plugin every time you type "eval [source code]" in console input text field,
		 ...
		 * <li>getDef:Function -> alias for <code>flash.utils.getDefinitionByName</code></li>
		...
		override protected function input(data:String):Boolean
		{
			if (data.indexOf("eval ") == 0)
			{
				...
				loader.contentLoaderInfo.addEventListener(Event.INIT, function(event:Event):void
				{
					...
					{
						consoleCore.println("Error executing code:");
